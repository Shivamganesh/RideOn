...
const Ridebooking = () => {
  ...
  const handleRideBooking = async () => {
    ...
    // Sending Request to create ride 
    await createRide({
      ...
      drop: {
        ...
        address: item?.drop_address || "Unknown Drop Location", // Fallback
      },
      pickup: {
        latitude: parseFloat(location.latitude),
        longitude: parseFloat(location.longitude),
        address: location.address || "Unknown Pickup Location", // Fallback
      },
    });
...
const RideOption = memo(({ ride, selected, onSelect }: any) => (
  ...
  {ride?.type}{" "}
  {ride?.isFastest && (
    <CustomText style={rideStyles.fastestLabel}>FASTEST</CustomText>
  )}
</CustomText>
